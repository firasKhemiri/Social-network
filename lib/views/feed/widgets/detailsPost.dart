...
import 'package:flutter_login/views/feed/widgets/ui_utils.dart';
...
class _DetailsPost extends State<DetailsPost> {
      ...
      slivers: <Widget>[
        SliverPersistentHeader(
          ...
          delegate: MyDynamicHeader(
              ...
              minImgWidth: this.widget.distWidth),
        ),
        // SliverList(
          ...
          child: SizedBox(
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  ClipRRect(
                    // borderRadius: lerpDist(BorderRadius.zero, BorderRadius.circular(25), context.widget., topOffset: 100),
                    child: Container(
                      height: 200,
  ...
  BorderRadius lerpDist(BorderRadius a, BorderRadius b, double t,
      {double botOffset = 1, double topOffset = 1}) {
...
class MyDynamicHeader extends SliverPersistentHeaderDelegate {
  ...
  MyDynamicHeader(
      {required this.height, required this.url, required this.minImgWidth});
